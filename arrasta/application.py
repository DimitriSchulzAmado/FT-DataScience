...
class DataTable(ttk.Treeview):
    ...
    def _draw_table(self, dataframe):
        self.delete(*self.get_children())  # pega todo o conteúdo do self.get_children()
        columns = list(dataframe.columns)  # transforma em lista
...
class SearchPage(tk.Frame):
    ...
    def _parse_drop_file(self, filename):
        #
        size = len(filename)  # mede o tamanho do filename
